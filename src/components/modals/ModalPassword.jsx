            ...
            <div className="sm:w-[450px] w-[90%] h-[300px] sm:h-3/5 flex  flex-col justify-center bg-white border-black rounded-xl text-center relative bottom-20">
               ...
               <div className=" w-full mb-5 flex flex-col justify-center items-center rounded ">
                   <label htmlFor="newPassword" className="flex flex-col items-start">
                        ...
                        <input type="email" name="newpasswordcorrea" id="" placeholder="Introducir tu correo " className=" ring-2 focus:outline-none focus:ring-blue-500 w-72 h-10 pl-2  text-gray-500 rounded"/>
                   </label>
               </div>
