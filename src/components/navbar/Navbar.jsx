      ...
      <div className="nabvar">
        ...
        >
          <BotomMasMobile>
            <div
              id="content_mas"
              className={`w-12 h-12 flex justify-center items-center rounded-3xl hover:bg-lime-700 `}
            >
          ...
          <BotomMas>
            <div
              id="moble_buttom-mas"
              className={`w-12 h-12 ml-28 flex justify-center items-center rounded-3xl hover:bg-lime-700`}
            >
              <NavItem icon={<BiPlusCircle className="opciones" />}>
                <ModalButtonMas />
              </NavItem>
